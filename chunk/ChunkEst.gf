...
lin
  copula_inf_Chunk = ss "olema" ;

  refl_SgP1_Chunk = ss "ennast" ;
  refl_SgP2_Chunk = ss "ennast" ;
  refl_SgP3_Chunk = ss "ennast" ;
  refl_PlP1_Chunk = ss "ennast" ;
  refl_PlP2_Chunk = ss "ennast" ;
  refl_PlP3_Chunk = ss "ennast" ;
  neg_Chunk = ss "ei" ;
  copula_Chunk = ss "on" ;
